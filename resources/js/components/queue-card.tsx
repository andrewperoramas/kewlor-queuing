        ...
        >
            ...
            <div className="mt-1 grid grid-cols-1 md:grid-cols-[300px_1fr_1fr_1fr]">
                ...
                <div className="pl-4">
                    {userQueue.admin_notes && (
                        <>
                            ...
                            <p className={`text-muted-foreground inline-block text-sm ${userQueue.is_working && 'text-white'}`}>
                                {userQueue.admin_notes}
                            </p>
                        </>
                    )}
                ...
                <div className="flex flex-col items-end justify-center">
                    ...
                    <div className="flex space-x-1 px-4 text-[#028a85]">
                        {userQueue.boost_count > 0 && (
                            <>
                                <p className="flex items-center text-sm font-thin text-yellow-700">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                                        className="icon icon-tabler icons-tabler-filled icon-tabler-bolt h-4 w-4"
                                    >
                        ...
                        <p className="flex items-center text-sm font-thin">ORIGINAL# {userQueue.initial_queue_number}</p>
                    </div>
                </div>
            </div>
        </Card>
