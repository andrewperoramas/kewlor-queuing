                    ...
                    <tbody className="divide-y divide-gray-200">
                        {userQueues.data.map((userQueue: App.Data.UserQueueData) => (
                            <tr key={userQueue.queue_number}>
                                <td className="px-6 py-4 w-[100px] whitespace-nowrap">{userQueue.queue_number}</td>
                                <td className="px-6 py-4 w-[100px] whitespace-nowrap">{userQueue.name}</td>
                                <td className="px-6 py-4 whitespace">{userQueue.message}</td>
